...
\node[right=4cm of DELAY2.east, anchor = west, text width=0cm] (TA) {};
\fill (TA) circle (3pt) node[below left] {$t_{2}$};
\node[above=0.1cm of TA.north, anchor = south] (TAABOVE) {};
\node[below=0.1cm of TA.south, anchor = north] (TABELOW) {};
...
\node[right=2cm of TA.east, anchor = west, text width=0cm] (STAT) {};
\fill (STAT) circle (3pt) node[below right] {stat(file)};
\node[below=0.1cm of STAT.south, anchor = north] (STATBELOW) {};

\node[right=2cm of STAT.east, anchor = west, text width=0.6cm] (T) {time};
...
\draw [|-|] (DELAY2ABOVE) -- node[above](){Action(s) that update file} (TAABOVE);
\draw [|-|] (TABELOW) -- node[below](){Delay} (STATBELOW);
