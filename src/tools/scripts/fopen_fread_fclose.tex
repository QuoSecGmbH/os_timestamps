...
\node[right=2cm of FOPEN.east, anchor = west, text width=0.6cm, inner sep=0, outer sep = 0] (FREAD) {};
\fill (FREAD) circle (3pt) node[above=0.1cm] {fread()};
\node[below=-0.1cm of FREAD.south, anchor = north] (FREAD_ARROW1) {};
\node[below=0.3cm of FREAD.south, anchor = north, inner sep=0, outer sep = 0] (FREAD_ARROW1p) {};
\node[below=0.8cm of FREAD_ARROW1.south, anchor = east] (FREAD_ARROW2) {A marked for update};

\node[right=2cm of FREAD.east, anchor = west, text width=0cm, inner sep=0, outer sep = 0] (FCLOSE) {};
\node[below=0.3cm of FCLOSE.south, anchor = north, inner sep=0, outer sep = 0] (FCLOSE_ARROW1) {};
...
\draw [-] (FOPEN) -- node[above](Z2){} (FREAD);
\draw [-] (FREAD) -- node[above](Z3){} (FCLOSE);
\draw [->] (ROOT) -- node[above](Z4){} (T);

\draw [->] (FREAD_ARROW2) -- node[above](){} (FREAD_ARROW1);
\draw [|-|] (FREAD_ARROW1p) -- node[below](){A updated} (FCLOSE_ARROW1);
