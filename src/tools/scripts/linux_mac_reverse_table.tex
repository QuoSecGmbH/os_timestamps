...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c|c}
 ...
 A & \cellmacb{A} & \cellmacb{A} & \cellmacb{A} & \cellmacb{.} & \cellmacb{.} & \cellmacb{.} & \cellmacb{.} & \cellmacb{a} & \cellmacb{A} & \cellmacb{.}\\
	\hline
 C & \cellmacb{C} & \cellmacb{.} & \cellmacb{.} & \cellmacb{C} & \cellmacb{C} & \cellmacb{C} & \cellmacb{C} & \cellmacb{C} & \cellmacb{C} & \cellmacb{C}\\
	\hline
...
\begin{minipage}{11.5cm}
 Verified against Ext4 on Ubuntu (18.04.3 LTS, 20.04.3 LTS) and ArchLinux 5.3.8; results should apply to other distributions
\end{minipage}

% \parbox{0.5\textwidth}{Verified against Ext4 on Ubuntu (18.04.3 LTS, 20.04.3 LTS) and ArchLinux 5.3.8; results should apply to other distributions}
% 2022-03-03 \url{https://github.com/QuoSecGmbH/os\_timestamps/} - Verified against Ext4 on Ubuntu 18.04.3 LTS, 20.04.3 LTS and ArchLinux 5.3.8, results should apply to other distributions
