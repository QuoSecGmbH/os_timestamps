...
void group_check_interfaces_file_fopen(testenv_struct* env){
    ...
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.R+B", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_RPB, "check_interfaces_file_fopen_fwrite_existing_RPB", "Yes", POSIX_c181, MANDATORY, "fopen(r+b)+fwrite +fcloseon existing file shall update file MC");
