...
void group_check_interfaces_ts_futimens(testenv_struct* env){
    ...
    runtest(env, "INTERFACES.TS.FUTIMENS.SET.OMIT", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_ts_futimens_set_omit, "check_interfaces_ts_futimens_set_omit", "Yes", POSIX_c181, NEEDNOT, "Setting M and A with futimens (UTIME_OMIT), C need not to be updated");
}
...
void group_check_interfaces_ts_utimensat(testenv_struct* env){
    ...
    runtest(env, "INTERFACES.TS.UTIMENSAT.SET.OMIT", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_ts_utimensat_set_omit, "check_interfaces_ts_utimensat_set_omit", "Yes", POSIX_c181, NEEDNOT, "Setting M and A with utimensat (UTIME_OMIT), C need not to be updated");
}
...
void group_check_interfaces_file_fopen(testenv_struct* env){
    ...
    runtest(env, "INTERFACES.FILE.FOPEN.NEW.W", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_new_W, "check_interfaces_file_fopen_new_W", "Yes", POSIX_c181, MANDATORY, "fopen(w) on non existing file shall create file, mark for update file MAC and parent directory MC");
    runtest(env, "INTERFACES.FILE.FOPEN.NEW.WB", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_new_WB, "check_interfaces_file_fopen_new_WB", "Yes", POSIX_c181, MANDATORY, "fopen(wb) on non existing file shall create file, mark for update file MAC and parent directory MC");
    runtest(env, "INTERFACES.FILE.FOPEN.NEW.A", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_new_A, "check_interfaces_file_fopen_new_A", "Yes", POSIX_c181, MANDATORY, "fopen(a) on non existing file shall create file, mark for update file MAC and parent directory MC");
    runtest(env, "INTERFACES.FILE.FOPEN.NEW.AB", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_new_AB, "check_interfaces_file_fopen_new_AB", "Yes", POSIX_c181, MANDATORY, "fopen(ab) on non existing file shall create file, mark for update file MAC and parent directory MC");
    runtest(env, "INTERFACES.FILE.FOPEN.NEW.W+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_new_WP, "check_interfaces_file_fopen_new_WP", "Yes", POSIX_c181, MANDATORY, "fopen(w+) on non existing file shall create file, mark for update file MAC and parent directory MC");
    runtest(env, "INTERFACES.FILE.FOPEN.NEW.WB+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_new_WBP, "check_interfaces_file_fopen_new_WBP", "Yes", POSIX_c181, MANDATORY, "fopen(wb+) on non existing file shall create file, mark for update file MAC and parent directory MC");
    runtest(env, "INTERFACES.FILE.FOPEN.NEW.W+B", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_new_WPB, "check_interfaces_file_fopen_new_WPB", "Yes", POSIX_c181, MANDATORY, "fopen(w+b) on non existing file shall create file, mark for update file MAC and parent directory MC");
    runtest(env, "INTERFACES.FILE.FOPEN.NEW.A+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_new_AP, "check_interfaces_file_fopen_new_AP", "Yes", POSIX_c181, MANDATORY, "fopen(a+) on non existing file shall create file, mark for update file MAC and parent directory MC");
    runtest(env, "INTERFACES.FILE.FOPEN.NEW.AB+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_new_ABP, "check_interfaces_file_fopen_new_ABP", "Yes", POSIX_c181, MANDATORY, "fopen(ab+) on non existing file shall create file, mark for update file MAC and parent directory MC");
    runtest(env, "INTERFACES.FILE.FOPEN.NEW.A+B", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_new_APB, "check_interfaces_file_fopen_new_APB", "Yes", POSIX_c181, MANDATORY, "fopen(a+b) on non existing file shall create file, mark for update file MAC and parent directory MC");
    
    runtest(env, "INTERFACES.FILE.FOPEN.EXISTING.W", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_existing_W, "check_interfaces_file_fopen_existing_W", "Yes", POSIX_c181, MANDATORY, "fopen(w) on existing file shall mark file MC for update");
    runtest(env, "INTERFACES.FILE.FOPEN.EXISTING.WB", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_existing_WB, "check_interfaces_file_fopen_existing_WB", "Yes", POSIX_c181, MANDATORY, "fopen(wb) on existing file shall mark file MC for update");
    runtest(env, "INTERFACES.FILE.FOPEN.EXISTING.W+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_existing_WP, "check_interfaces_file_fopen_existing_WP", "Yes", POSIX_c181, MANDATORY, "fopen(w+) on existing file shall mark file MC for update");
    runtest(env, "INTERFACES.FILE.FOPEN.EXISTING.WB+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_existing_WBP, "check_interfaces_file_fopen_existing_WBP", "Yes", POSIX_c181, MANDATORY, "fopen(wb+) on existing file shall mark file MC for update");
    runtest(env, "INTERFACES.FILE.FOPEN.EXISTING.W+B", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_existing_WPB, "check_interfaces_file_fopen_existing_WPB", "Yes", POSIX_c181, MANDATORY, "fopen(w+b) on existing file shall mark file MC for update");
    
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.W", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_W, "check_interfaces_file_fopen_fwrite_existing_W", "Yes", POSIX_c181, MANDATORY, "fopen(w)+fwrite+fclose on existing file shall update file MC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.WB", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_WB, "check_interfaces_file_fopen_fwrite_existing_WB", "Yes", POSIX_c181, MANDATORY, "fopen(wb)+fwrite+fclose on existing file shall update file MC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.W+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_WP, "check_interfaces_file_fopen_fwrite_existing_WP", "Yes", POSIX_c181, MANDATORY, "fopen(w+)+fwrite+fclose on existing file shall update file MC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.WB+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_WBP, "check_interfaces_file_fopen_fwrite_existing_WBP", "Yes", POSIX_c181, MANDATORY, "fopen(wb+)+fwrite+fclose on existing file shall update file MC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.W+B", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_WPB, "check_interfaces_file_fopen_fwrite_existing_WPB", "Yes", POSIX_c181, MANDATORY, "fopen(w+b)+fwrite+fclose on existing file shall update file MC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.R+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_RP, "check_interfaces_file_fopen_fwrite_existing_RP", "Yes", POSIX_c181, MANDATORY, "fopen(r+)+fwrite+fclose on existing file shall update file MC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.RB+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_RBP, "check_interfaces_file_fopen_fwrite_existing_RBP", "Yes", POSIX_c181, MANDATORY, "fopen(rb+)+fwrite+fclose on existing file shall update file MC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.R+B", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_RPB, "check_interfaces_file_fopen_fwrite_existing_RPB", "Yes", POSIX_c181, MANDATORY, "fopen(r+b)+fwrite+fclose on existing file shall update file MC");
    
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.DIR.W", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_dir_W, "check_interfaces_file_fopen_fwrite_existing_dir_W", "Yes", "", MANDATORY, "fopen(w)+fwrite+fclose on existing file shall not update parent directory MAC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.DIR.WB", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_dir_WB, "check_interfaces_file_fopen_fwrite_existing_dir_WB", "Yes", "", MANDATORY, "fopen(wb)+fwrite+fclose on existing file shall not update parent directory MAC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.DIR.W+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_dir_WP, "check_interfaces_file_fopen_fwrite_existing_dir_WP", "Yes", "", MANDATORY, "fopen(w+)+fwrite+fclose on existing file shall not update parent directory MAC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.DIR.WB+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_dir_WBP, "check_interfaces_file_fopen_fwrite_existing_dir_WBP", "Yes", "", MANDATORY, "fopen(wb+)+fwrite+fclose on existing file shall not update parent directory MAC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.DIR.W+B", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_dir_WPB, "check_interfaces_file_fopen_fwrite_existing_dir_WPB", "Yes", "", MANDATORY, "fopen(w+b)+fwrite+fclose on existing file shall not update parent directory MAC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.DIR.R+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_dir_RP, "check_interfaces_file_fopen_fwrite_existing_dir_RP", "Yes", "", MANDATORY, "fopen(r+)+fwrite+fclose on existing file shall not update parent directory MAC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.DIR.RB+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_dir_RBP, "check_interfaces_file_fopen_fwrite_existing_dir_RBP", "Yes", "", MANDATORY, "fopen(rb+)+fwrite+fclose on existing file shall not update parent directory MAC");
    runtest(env, "INTERFACES.FILE.FOPEN_FWRITE_FCLOSE.EXISTING.DIR.R+B", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fwrite_existing_dir_RPB, "check_interfaces_file_fopen_fwrite_existing_dir_RPB", "Yes", "", MANDATORY, "fopen(r+b)+fwrite+fclose on existing file shall not update parent directory MAC");
    ...
    runtest(env, "INTERFACES.FILE.FOPEN_FREAD.EXISTING.R", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fread_existing_R, "check_interfaces_file_fopen_fread_existing_R", "Yes", POSIX_c181, MANDATORY, "fopen(r)+fread on existing file shall mark A for update");
    runtest(env, "INTERFACES.FILE.FOPEN_FREAD.EXISTING.RB", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fread_existing_RB, "check_interfaces_file_fopen_fread_existing_RB", "Yes", POSIX_c181, MANDATORY, "fopen(rb)+fread on existing file shall mark A for update");
    runtest(env, "INTERFACES.FILE.FOPEN_FREAD.EXISTING.R+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fread_existing_RP, "check_interfaces_file_fopen_fread_existing_RP", "Yes", POSIX_c181, MANDATORY, "fopen(r+)+fread on existing file shall mark A for update");
    runtest(env, "INTERFACES.FILE.FOPEN_FREAD.EXISTING.RB+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fread_existing_RBP, "check_interfaces_file_fopen_fread_existing_RBP", "Yes", POSIX_c181, MANDATORY, "fopen(rb+)+fread on existing file shall mark A for update");
    runtest(env, "INTERFACES.FILE.FOPEN_FREAD.EXISTING.R+B", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fread_existing_RPB, "check_interfaces_file_fopen_fread_existing_RPB", "Yes", POSIX_c181, MANDATORY, "fopen(r+b)+fread on existing file shall mark A for update");
    
    runtest(env, "INTERFACES.FILE.FOPEN_FREAD.EXISTING.W+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fread_existing_WP, "check_interfaces_file_fopen_fread_existing_WP", "Yes", POSIX_c181, MANDATORY, "fopen(w+)+fread (nmemb>0) on existing file shall mark A for update");
    runtest(env, "INTERFACES.FILE.FOPEN_FREAD.EXISTING.WB+", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fread_existing_WBP, "check_interfaces_file_fopen_fread_existing_WBP", "Yes", POSIX_c181, MANDATORY, "fopen(wb+)+fread (nmemb>0) on existing file shall mark A for update");
    runtest(env, "INTERFACES.FILE.FOPEN_FREAD.EXISTING.W+B", 1, REPEAT_WORST, s_0s, ns_10ms, check_interfaces_file_fopen_fread_existing_WPB, "check_interfaces_file_fopen_fread_existing_WPB", "Yes", POSIX_c181, MANDATORY, "fopen(w+b)+fread (nmemb>0) on existing file shall mark A for update");
}
