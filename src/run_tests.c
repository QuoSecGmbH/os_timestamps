...
void group_check_general_update(testenv_struct* env){ 
    ...
    runtest(env, "GENERAL.UPDATE.READ", 2, REPEAT_WORST, s_0s, ns_10ms, check_general_update_read, "check_general_update_read", "Yes", POSIX_c181, MANDATORY, "fread shall not update A");
