...
int check_interfaces_file_w_fputws_fflush_imm(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path = (char*) misc_concat_ensure_file_exists(dir_path, "interfaces.file.w.fputws_fflush.IMM" , s_0s, ns_100ms, output_file, error_file, __func__);
