#ifndef I_FILE_W_FPUTC_C
#define I_FILE_W_FPUTC_C

#include "i_file_w_fputc.h"

int check_interfaces_file_w_fputc_fflush_imm(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path = (char*) misc_concat_ensure_file_exists(dir_path, "interfaces.file.w.fputc_fflush.IMM" , s_0s, ns_100ms, output_file, error_file, __func__);
...
int check_interfaces_file_w_fputc_fclose(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path = (char*) misc_concat_ensure_file_exists(dir_path, "interfaces.file.w.fputc_fclose" , s_0s, ns_100ms, output_file, error_file, __func__);
...
int check_interfaces_file_w_fputc_exit(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path = (char*) misc_concat_ensure_file_exists(dir_path, "interfaces.file.w.fputc_exit" , s_0s, ns_100ms, output_file, error_file, __func__);
...
int check_interfaces_file_w_fputc_abort(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path = (char*) misc_concat_ensure_file_exists(dir_path, "interfaces.file.w.fputc_abort" , s_0s, ns_100ms, output_file, error_file, __func__);
