#ifndef I_FILE_W_FWPRINTF_C
#define I_FILE_W_FWPRINTF_C

#include "i_file_w_fwprintf.h"

int check_interfaces_file_w_fwprintf_fflush_imm(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path = (char*) misc_concat_ensure_file_exists(dir_path, "interfaces.file.w.fwprintf_fflush.IMM" , s_0s, ns_100ms, output_file, error_file, __func__);
...
int check_interfaces_file_w_fwprintf_fflush(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path = (char*) misc_concat_ensure_file_exists(dir_path, "interfaces.file.w.fwprintf_fflush" , s_0s, ns_100ms, output_file, error_file, __func__);
...
int check_interfaces_file_w_fwprintf_fclose(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path = (char*) misc_concat_ensure_file_exists(dir_path, "interfaces.file.w.fwprintf_fclose" , s_0s, ns_100ms, output_file, error_file, __func__);
...
int check_interfaces_file_w_fwprintf_exit(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path = (char*) misc_concat_ensure_file_exists(dir_path, "interfaces.file.w.fwprintf_exit" , s_0s, ns_100ms, output_file, error_file, __func__);
...
int check_interfaces_file_w_fwprintf_abort(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path = (char*) misc_concat_ensure_file_exists(dir_path, "interfaces.file.w.fwprintf_abort" , s_0s, ns_100ms, output_file, error_file, __func__);
