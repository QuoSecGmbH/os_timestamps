#ifndef I_FILE_W_PUTS_C
#define I_FILE_W_PUTS_C
...
// int check_interfaces_file_w_puts_fclose(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
//     char* path = (char*) misc_concat_ensure_file_exists(dir_path, "interfaces.file.w.puts_fclose" , s_0s, ns_100ms, output_file, error_file, __func__);
//     
//     struct timespec* ts_before = current_time_ns_fslike_osspecific();
//     
//     FILE* f = stdout;
