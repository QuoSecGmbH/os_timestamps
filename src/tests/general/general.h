...
int check_general_update_chmod_close(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path);
...
int check_general_update_chmod_stat(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path);
