...
int check_utilities_ex_new_i_w_q(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path_dir = misc_concat_ensure_dir_exists(dir_path, "utilities.ex.new.i.w.q/", 0, 0, output_file, error_file, __func__);
    ...
    char* command = "ex ../targetdir/file";
...
int check_utilities_ex_new_i_w_q_mac(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path_file = misc_concat(dir_path, "utilities.ex.new.i.w.q/targetdir/file");
...
int check_utilities_ex_existing_i_w_q(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path_dir = misc_concat_ensure_dir_exists(dir_path, "utilities.ex.existing.i.w.q/", 0, 0, output_file, error_file, __func__);
...
int check_utilities_ex_existing_i_w_q_mc(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path_file = misc_concat(dir_path, "utilities.ex.existing.i.w.q/targetdir/file");
...
int check_utilities_ex_existing_i_wq(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path_dir = misc_concat_ensure_dir_exists(dir_path, "utilities.ex.existing.i.wq/", 0, 0, output_file, error_file, __func__);
...
int check_utilities_ex_existing_i_wq_mc(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path_file = misc_concat(dir_path, "utilities.ex.existing.i.wq/targetdir/file");
...
int check_utilities_ex_existing_i_x(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path_dir = misc_concat_ensure_dir_exists(dir_path, "utilities.ex.existing.i.x/", 0, 0, output_file, error_file, __func__);
...
int check_utilities_ex_existing_i_x_mc(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path_file = misc_concat(dir_path, "utilities.ex.existing.i.x/targetdir/file");
...
int check_utilities_ex_existing_i_qEM(FILE* csv_file, FILE* output_file, FILE* error_file, char* dir_path){
    char* path_dir = misc_concat_ensure_dir_exists(dir_path, "utilities.ex.existing.i.qEM/", 0, 0, output_file, error_file, __func__);
